...
/// <summary>
/// ウィザードの各ステップの入力を検証するロジックを提供する。状態を持たないため<see langword="static"/>クラスとする。
/// </summary>
public static class WizardValidationEngine
{
	/// <summary>
	/// Step1(氏名・メールアドレス)の入力を検証する。
	/// </summary>
	public static ValidationResult ValidateStep1(WizardState state)
	{
	...
	/// </summary>
	public static ValidationResult ValidateStep2(WizardState state)
	{
